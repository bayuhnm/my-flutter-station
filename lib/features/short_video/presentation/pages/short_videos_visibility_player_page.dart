...
class ShortVideosVisibilityPlayerPage extends StatelessWidget {
  const ShortVideosVisibilityPlayerPage({super.key});
        ...
        children: [
          PageView.builder(
            ...
            itemBuilder: (context, index) {
              return PureShortVideoTile(
                item: demoShortVideos[index],
                autoPlay: index == 0,
